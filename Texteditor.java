...
public class Texteditor extends JFrame implements ActionListener
	{
            MenuBar mbar;
            Menu file,edit,format,font,font1,font2,color,foreground,background,search;
            ...
            MenuItem fsize1,fsize2,fsize3,fsize4,fsize5,fsize6,fsize7,fsize8,fsize9,fsize10,fsize11,fsize12;
	    MenuItem fcolor1,fcolor2,fcolor3,fcolor4,fcolor5;
	    MenuItem bcolor1,bcolor2,bcolor3,bcolor4,bcolor5;
			...
			public Texteditor(String str)
				{
					...
					font.add(fname1=new MenuItem("Serif"));
					...
					font2.add(fsize6=new MenuItem("24"));
					font2.add(fsize7=new MenuItem("26"));
					font2.add(fsize8=new MenuItem("28"));
					font2.add(fsize9=new MenuItem("30"));
					font2.add(fsize10=new MenuItem("32"));
					font2.add(fsize11=new MenuItem("34"));
					font2.add(fsize12=new MenuItem("36"));
					
					search.add(find=new MenuItem("Find"));
					search.add(replace=new MenuItem("Replace"));
					mbar.add(search);
					...
					foreground.add(fcolor1=new MenuItem("F-White"));
					foreground.add(fcolor2=new MenuItem("F-Blue"));
					foreground.add(fcolor3=new MenuItem("F-Red"));
					foreground.add(fcolor4=new MenuItem("F-Yellow"));
					foreground.add(fcolor5=new MenuItem("F-Green"));
					
					background.add(bcolor1=new MenuItem("B-Green"));
					background.add(bcolor2=new MenuItem("B-Blue"));
					background.add(bcolor3=new MenuItem("B-Red"));
					background.add(bcolor4=new MenuItem("B-Yellow"));
					background.add(bcolor5=new MenuItem("B-Black"));
					mbar.add(color);
					...
					fcolor1.addActionListener(this);
					fcolor2.addActionListener(this);
					fcolor3.addActionListener(this);
					fcolor4.addActionListener(this);
					fcolor5.addActionListener(this);
		...
		public void actionPerformed(ActionEvent ae)
			{
				...
				if(command.equals("New..."))
					{
						dispose();
						Texteditor note1 = new Texteditor("Text Editor-Untitled ");
			...
			try
				...
				if(command.equals("32"))
					{
						...
						f=new Font(fontName,fontStyle,32);
						text.setFont(f);
					}
				if(command.equals("34"))
					{
						...
						f=new Font(fontName,fontStyle,34);
						text.setFont(f);
					}
				...
				if(command.equals("F-White"))
					{	
						text.setForeground(Color.WHITE);
					}
				if(command.equals("F-Blue"))
					{	
						text.setForeground(Color.BLUE);
					}
				if(command.equals("F-Red"))
					{	
						text.setForeground(Color.RED);
					}
				if(command.equals("F-Yellow"))
					{	
						text.setForeground(Color.YELLOW);
					}
				if(command.equals("F-Green"))
					{	
						text.setForeground(Color.GREEN);
					}
				if(command.equals("B-Green"))
					{	
						text.setBackground(Color.GREEN);
					}
				if(command.equals("B-Blue"))
					{	
						text.setBackground(Color.BLUE);
					}
				if(command.equals("B-Red"))
					{	
						text.setBackground(Color.RED);
					}
				if(command.equals("B-Yellow"))
					{	
						text.setBackground(Color.YELLOW);
					}
				if(command.equals("B-Black"))
					{	
